...
; knows that there are five kinds of U.S. coins). It would be nicer to be able
...
; or why not?
;
; No it doesn't. That's because the "root" of the algorithm remains valid. The
; number of ways to make change with a given set of coins is equal to the sum of
; the number of ways to make change of that same amount with all coins but the
; first denominator and the number of ways to make change of the amount minus 
; the first denominator with all coins.
